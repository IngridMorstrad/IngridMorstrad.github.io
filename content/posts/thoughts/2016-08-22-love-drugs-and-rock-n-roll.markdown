...
- http://www.nature.com/nrn/journal/v12/n11/box/nrn3119_BX2.html
...
## Footnotes
[^1]: I also enjoy 500 Days of Summer and Before Sunrise.
[^2]: Specifically, for early-stage romantic love.
[^3]: Although the name "dope"amine may seem fitting, the connection is coincidental. Dopamine comes from DOPA (DiOxypPhenylAlanine) + amine.
[^4]: There are other factors that contribute to causing addictive behaviour as well.
[^5]: If not for anything else, for this article.
[^6]: The levels of dopamine are controlled by other hormones like ghrelin, insulin, leptin, etc.
