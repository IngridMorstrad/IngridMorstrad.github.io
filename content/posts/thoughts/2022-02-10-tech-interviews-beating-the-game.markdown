...
If you find that the problems are too hard, try solving some easy problems to build up momentum (spend 20-40 minutes on each problem). If easy problems are still too hard, start reading the solution "actively". Meaning, you stop reading the solution as soon as you think you gained enough information to make some progress. If you get stuck again, continue reading the solution. Once you've got an idea of how to solve the problem, it is *very* important to solve it immediately (and then return to it again a few days later, i.e., leverage spaced repetition). A few other tips to keep in mind when solving problems:
...
- Read the forums to find other solutions that may improve upon your code. However, you may not want to use algorithms with fancy tricks that the interviewer may not understand (provided there are other algorithms as optimal).
- Write clean code, with proper variable names always. This gives you a good gauge of how long it will take you to actually solve the problem, and is good practice for all interviews.
- Don't hack your way through the problem. Think of a solution from start-to-end and then begin coding.
...
Lastly, you should plan on doing **nothing** the day before the interview. As a professor once told me, "If you haven't gotten to it by the last day, you're probably not going to be able to really get it on the last day either". You've done enough. Wind down and relax instead. You got this!
