...
# Travel-related
ChatGPT was quite helpful answering questions about the areas I was visiting in Europe. For example, I was confused by all the buildings and names, and seeked help in the form of the question: "What was the Domus Flavia part of?". ChatGPT answered that it was Domitian's palace, which among other things included a basilica. That confused me even more, as evident in my follow-up: "Is that the same basilica as the basilica of Constantine?". The answer was no.
...
You can ask AI to give you answers to questions that you know to. for example when using the AI as a tour guide, I asked it to describe the significance of the painting, but also asked it to list the main figures in the painting of it wouldn't get the second part right and I knew it was hallucinating. Some of the prompts I used:
...
I added to this with, "Also state which parts of the painting to look at more deeply" to understand if it was hallucinating.
...
I have a few YouTube videos saved to my playlist that I haven't seen for months these days to be on the longer side (over an hour long in some cases). I got the transcript for the YouTube video using [note GPT](notegpt.io) and then paste the transcript into an LLM for summarization. Then I'd either skip the entire video - saving an hour of my time - or I'd at least be able to focus more easily on the video since I had an idea of what the video would be covering.
